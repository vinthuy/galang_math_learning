...
func TestFirstCountStr(t *testing.T) {
	t.Log(FirstCountStr("abaccdeff"))
}

func TestReversWorld(t *testing.T) {
	var testStr = "I am a student"
	t.Log(RerverString(testStr))
}

func TestRoateWorld(t *testing.T) {
	testStr := "abcdefg"
	t.Log(RonateWorld(testStr,2))
}
